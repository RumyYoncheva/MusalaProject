...
namespace MusalaProjectTests.Pages.HomePage.ContactForm
{
    ...
    {
        public static IWebElement ContactFormPopUp => DriverContext.WaitAndFindElement(By.Id("contact_form_pop"));
        ...
        //public static IWebElement FieldValidation => DriverContext.WaitAndFindElement(By.CssSelector("wpcf7-not-valid-tip"));
